...
export class SlotsComponent {
  ...
  constructor(private appComponent: AppComponent) {
    ...
    this.balance = storedBalance ? parseFloat(storedBalance) : parseFloat(this.appComponent.kaska.toFixed(2));
  ...
  checkWin() {
    ...
    this.balance = parseFloat(this.balance.toFixed(2))
    this.appComponent.kaska = this.balance; // Update kaska with the current balance
    this.updateBalance()
  }
